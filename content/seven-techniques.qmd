...
- **HR:** Policy and programme design with stakeholder, legal, operational, and fairness considerations
...
- "I need to design an onboarding programmemememe for graduate hires. Ask me questions to ensure I've thought through all the key elements."
...
- "I need to design a customer loyalty programmemememe. What questions should I be asking to ensure it's viable and profitable?"
...
- "Analyse different IT governance models: centralised, decentralised, federated. What are the trade-offs for control, innovation, and efficiency?"
...
### Teaching Tip
This is excellent for **individual revision or exam prep**. Students can practise the process multiple times, and each time they can ask the AI to introduce complications: "In Step 3, what if the employee refuses to sign the written warning?" The AI will explain how to handle variations.
...
### Why It Works Across Disciplines
Business work is fundamentally about interaction - with clients, stakeholders, teams, and colleagues. Students can memorize theory, but until they practise *actually having* difficult conversations where others push back, get emotional, or raise objections, they won't develop genuine interpersonal competence.
...
Now the student has to manage a realistic, emotionally charged scenario. They must practise de-escalation, empathy, procedural fairness, and documentation - all while the AI responds dynamically to what they say.
...
- AI plays a sceptical internal stakeholder who needs to be convinced of a strategy
...
- AI plays a board member scrutinising a financial decision
...
### Teaching Tip
This technique is perfect for **preparing students for case study exams**. Instead of memorizing model answers, they practise analysing competing priorities and justifying nuanced positions - exactly what they'll need to do in professional practice.
...
**Student Prompt:**
```
I'm studying for an exam on Australian employment law. I need to practise
...
**What Happens:**
Students can generate multiple practice exams with different questions each time. They enter the real exam having practised extensively.
...
```
I want to practise identifying workplace bullying vs. performance management
...
**Result:** Students can practise until they achieve mastery, not until they run out of practice problems.
...
```
I want to practise identifying workplace bullying vs. legitimate performance
...
> "Before your next exam, use AI to practise until you achieve 90% accuracy on hard scenarios. Submit a screenshot showing your progression and a 100-word reflection on what you learned."
...
> "After developing your strategy based on expert consultation, role-play presenting it to a sceptical stakeholder (CFO, union rep, CEO) and defend your choices."
...
4. Student uses **Role Play** to practise explaining the policy to a sceptical manager
...
Remember: these aren't just AI tools - they're pedagogical strategies. The AI just makes them scalable and available to every student, any time they want to practise.
